...
logger = setup_logging('upload_to_supabase', log_to_file=True)
...
def main():
    """Main function"""
    if len(sys.argv) < 2:
        print("Usage: python3 upload_to_supabase.py <csv_file>")
        print("Example: python3 upload_to_supabase.py output/2025-12-26/cleaned_data.csv")
        sys.exit(1)
